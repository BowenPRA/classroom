...
export const plan = {
  ...
  timeline: [
    { time: '0–3 min', phase: 'Set up', detail: 'Choose a board. Four are Year 7 — Mathematics 1.1–1.3, Science 1.1–1.3, the Revision board that runs one category per unit across all six, and the Unit 1 Finale (Maths 1.4–1.6, Science 1.4, and two rounds of trivia) — plus the red Science Unit 2 board. The indigo Teens board and the orange Teens 2 board, last in the list, are for the Teens class only. The fifth, in pink, is Kindergarten & Year 1, and the sixth, in green, is the Year 1 picture board; neither belongs to Year 7, so do not open them in front of that class. Then type the team names. Two to six teams; four teams of six is about right for a class of 24.' },
  ...
  answers: [
    ...
    { q: 'Science Unit 2 board · what is on it', a: 'The red board, Science 2.1–2.7 (there is no 2.4 deck, so no 2.4). Six categories: States of Matter · Particles · Changes of State · Elements & Symbols · Compounds & Formulae · Compound or Mixture? Twenty-nine of the thirty clues carry a picture. Most are the photographs from the lessons; the particle boxes, the symbol squares, H₂O, Co and CO, the heating curve and the air pie were drawn for the board.' },
    { q: 'Science Unit 2 board · the answers', a: 'Solid · liquid (mercury) · no, each grain is a solid · a gas · you squash the AIR in the holes || solid · gas · liquid · a vacuum · liquid particles move past one another || melt · boil, steam · evaporation is slow and from the surface · from the AIR, it condenses · boiling, so the heat changes liquid to gas || carbon · period (row), group (column) · Cl · natrium · Co is cobalt, CO is carbon monoxide || water, 2 H and 1 O · NaCl · CO₂ · salt, new properties · copper, sulfur, oxygen || mixture · iron sulfide · nitrogen 78, oxygen 21 · carbon dioxide, CO₂ · no, tap water is water plus minerals' },
    { q: 'Science Unit 2 board · the traps', a: 'Particles 300: the liquid box LOOKS full at the bottom — the test is touching but no pattern. Changes of State 400: the water on the outside of the glass comes from the air, never through the glass. Elements 300: Cl, not CL or cl. Elements 500: Co and CO differ by one capital letter and are completely different substances. Compounds 400: two dangerous elements make something you eat — say "new properties" out loud.' },
    { q: 'Science Unit 2 board · the pictures', a: 'Question pictures show as the clue opens; six answer pictures (balloon, graphite and diamond, glass of water, salt field, iron sulfide, kettle limescale) wait for Show the answer. Most photographs are CC BY or CC BY-SA, so the names travel with them in images/CREDITS.json: Bionerd, Pauloleong2002, Benh LIEU SONG, Johan, Zvonimirl, Plorpy2, James Petts, Robert M. Lavinsky, Mouryan, Dnn87, Dubravko Sorić, Richard Wheeler, Vinnie Cartabiano, Crystal Titan, Asoult, Benjamin Arnold, Simon A. Eugster and Henna.' },
    { q: 'Teens board · what is on it', a: 'The indigo board, last in the list, for the Teens class. Five categories: Chemistry and Physics at IGCSE level, then Word History, Pop Songs and Big Numbers. The science needs a calculation or a reason on almost every clue; the other three are there so the two strongest scientists cannot win alone. Turn the timer OFF in Setup — thirty seconds is not enough for a mole calculation.' },
    { q: 'Teens board · the answers', a: 'Hydrogen · 11 p, 12 n, 11 e · Fe₂O₃ + 3CO → 2Fe + 3CO₂ · Mr 100, 0.25 mol · chlorine at the anode, hydrogen at the cathode, sodium hydroxide left || they land together · 36 km/h · 3 Ω and 4 A · 20 g · 1.5 × 10¹¹ m || the Earl of Sandwich · forced work · forty days · oxygen (HCl has none) · te by sea, cha by land || BTS · Baby Shark Dance · Billie Eilish · 2019 · she did not own her masters || 100 zeros · 2¹⁰ = 1024 · about 470 million · 2⁶³ · 2³¹ − 1, the 32-bit limit' },
    { q: 'Teens board · the traps', a: 'Chemistry 500: the cathode gives HYDROGEN, not sodium — sodium is more reactive than hydrogen, so it stays in solution. Physics 300: two resistors in parallel give LESS resistance than one. Big Numbers 400: square 1 has 2⁰ grains, so square 64 has 2⁶³, not 2⁶⁴. Physics 100: a heavier thing does not fall faster; air resistance is what makes the feather slow on Earth.' },
    { q: 'Teens board · pop songs', a: 'Every pop clue is a fact about a song — a record, a year, a reason — never a line from it. Do not add lyric clues: lyrics are copyrighted and this site is public. The chart facts are checked to 2025; records change, so if a student says a newer video has more views than Baby Shark Dance, the clue still asks for the FIRST to pass 10 billion.' },
    { q: 'Teens 2 board · what is on it', a: 'The orange board, last in the list. All trivia, no syllabus: Myth or Fact?, Celebrity Couples, Famous Covers, Geography and Accidental Inventions. Play it after the first Teens board, or on its own when the class needs a break from science. The rule does not change: an answer with no reason scores nothing. On Myth or Fact, the reason IS the answer.' },
    { q: 'Teens 2 board · the answers', a: 'Myth (they remember for months) · fact (seeds inside) · myth (Empire State, 20+ a year) · fact (243 vs 225 days) · myth (WWII radar cover story) || American football · Katy Perry · Spider-Man · Rosario · she was his mentor || Dolly Parton · Leonard Cohen · Otis Redding · a French song from 1784 · Tracy Chapman, first Black songwriter to win CMA Song of the Year || Canberra · Laos · India · China, Myanmar, Laos, Thailand, Cambodia, Vietnam · the Diomede Islands, split by the Date Line || penicillin · the microwave · the Post-it Note · Velcro · wallpaper cleaner' },
    { q: 'Teens 2 board · couples and covers', a: 'Celebrity couples change. Every couples clue is pinned to an event and a year — engaged in 2025, seen on dates in 2025, met in 1989 — so it stays true even if a couple splits. If a student says they have broken up, the clue is still right; say so and move on. The covers clues name songs and tell their history but never quote a line: lyrics are copyrighted and this site is public.' },
