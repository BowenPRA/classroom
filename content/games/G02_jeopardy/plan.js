...
export const plan = {
  ...
  timeline: [
    { time: '0–3 min', phase: 'Set up', detail: 'Choose a board. Four are Year 7 — Mathematics 1.1–1.3, Science 1.1–1.3, the Revision board that runs one category per unit across all six, and the Unit 1 Finale (Maths 1.4–1.6, Science 1.4, and two rounds of trivia) — plus the red Science Unit 2 board. The indigo Teens board, last in the list, is for the Teens class only. The fifth, in pink, is Kindergarten & Year 1, and the sixth, in green, is the Year 1 picture board; neither belongs to Year 7, so do not open them in front of that class. Then type the team names. Two to six teams; four teams of six is about right for a class of 24.' },
