...
export const PICS = {
  ...
  chair, cheese, chocolate, chopsticks, clock, cloud, coconut, coffee, coin,
  comb, cow, crab, crayon, dog, doughnut, duck, egg, elephant, fish, flower,
  fork, fridge, ginger, giraffe, glasses, glue, grapes, grass, hat, hen,
  icecream, jar, juice, kettle, key, kite, lamp, leaf, microwave, milk,
  monkey, moon, nail, octopus, onion, orange, oven, owl, pan, parrot, pencil,
  penguin, pig, pillow, plane, pot, potato, prawn, rainbow, rug, sandpit,
  scissors, seesaw, shark, sheep, shell, shoe, slide, snake, snow, soap, sock,
  sofa, spider, spoon, squid, starfish, straw, sun, tea, teddy, television,
  tiger, toaster, toothbrush, towel, tree, tshirt, turtle, water, whale,
  windowpane, wok, woodenspoon,
}
