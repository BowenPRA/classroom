...
export const plan = {
  ...
  objective:
    ...
    + '(farm animals, clothes, weather), initial sounds and rhyme, and the habit of justifying a guess in English.',
  materials: [
  ...
  timeline: [
    { time: '0–1 min', phase: 'Choose', detail: 'Open the puzzle list and pick by band. Kindergarten–Year 1: Picture Sort, Read and Match, First Sounds. Year 1–4: the eleven word puzzles, roughly easiest first.' },
  ...
  answers: [
    ...
    { q: 'The two deliberate traps', a: 'Rhyme Time: SQUARE is a shape but belongs with the BEAR rhymes. Opposites and Animals: COW is a farm animal but belongs with the OW spellings. Let the class fall in; that is the lesson.' },
  ],
  notes:
