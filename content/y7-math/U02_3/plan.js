...
export const plan = {
  ...
  timeline: [
    ...
    { time: '21–27 min', phase: 'The invisible 1', detail: 'Slide 11: vote A (8) or B (7s), no discussion of the answer. Slide 12: 7s; copy x MEANS 1x. Slide 13: 5 cm + 3 kg; copy ONLY LIKE TERMS. Slide 14: five on whiteboards, then Check.' },
    ...
    { time: '33–38 min', phase: 'Keep the sign', detail: 'Slide 17: vote A (4x + 6y) or B (10x + 6y). Slide 18: step through the first expression and stop on Move — point at the −3x travelling. Slide 19: copy KEEP THE SIGN; a and b on whiteboards.' },
