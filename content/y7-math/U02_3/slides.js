...
export const slides = [
  ...
  // ── THE INVISIBLE 1 ───────────────────────────────────────────────────────
  // 11. Question only. Take a vote; do not settle it.
  {
    layout: 'compare',
    accent: PURPLE,
    icon: 'MessageSquare',
    eyebrow: 'Both simplified 8s − s. Only one is right.',
    eyebrowVn: 'Cả hai cùng rút gọn 8s − s. Chỉ một bạn đúng.',
    ...
    columns: [
      {
        ...
        content: '"The s is gone."',
        contentVn: '"Chữ s mất rồi."',
        caption: 'Hands up for A.',
        captionVn: 'Giơ tay nếu chọn A.',
      },
      {
        heading: 'Answer B',
        headingVn: 'Đáp án B',
        ...
        content: '"One s is gone."',
        contentVn: '"Mất một s."',
        caption: 'Hands up for B. No changing your mind.',
        captionVn: 'Giơ tay nếu chọn B. Không được đổi ý.',
      },
    ],
  },
  ...
  // ── THE SIGN TRAVELS ──────────────────────────────────────────────────────
  // 17. Question only. Vote; do not settle it.
  {
    layout: 'compare',
    accent: PURPLE,
    icon: 'MessageSquare',
    eyebrow: 'Both simplified 7x + 5y − 3x + y. Only one is right.',
    eyebrowVn: 'Cả hai cùng rút gọn 7x + 5y − 3x + y. Chỉ một bạn đúng.',
    ...
    columns: [
      {
        ...
        content: '"We collected the x terms, then the y terms."',
        contentVn: '"Chúng em gộp các hạng tử x, rồi các hạng tử y."',
        caption: 'Hands up for A.',
        captionVn: 'Giơ tay nếu chọn A.',
      },
      {
        ...
        content: '"We collected the x terms, then the y terms."',
        contentVn: '"Chúng em gộp các hạng tử x, rồi các hạng tử y."',
        caption: 'Hands up for B. What did the other pair do?',
        captionVn: 'Giơ tay nếu chọn B. Cặp kia đã làm gì?',
      },
    ],
  },
