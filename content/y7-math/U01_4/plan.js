...
export const plan = {
  ...
  timeline: [
    ...
    { time: '5–9 min', phase: 'The hook', detail: 'Slide 2, QUESTION ONLY: 24 pencils and 80 sheets of paper, identical packs, nothing left over — greatest number of packs? Guesses on the board, no method. It gets answered on slide 9. Do not solve it here.' },
  ...
  answers: [
    ...
    { q: 'Hook: 24 pencils, 80 sheets, identical packs', a: '8 packs. HCF(24, 80) = 8, so each pack has 24 ÷ 8 = 3 pencils and 80 ÷ 8 = 10 sheets, nothing left over.' },
  ...
  notes:
    ...
    'Slide 2 (the pencils and paper) is a question slide with no method on it; the guesses matter, and slide 9 is where it pays off. Do not work it out early. The numbers are the book\'s own worked example, 24 and 80, so the hook and the method are the same problem seen twice. ' +
